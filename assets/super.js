...
//Забираем данные из массива в формате JSON
document.addEventListener('DOMContentLoaded',function(event){
    ...
    // Проходимся по всем элементам рейтинга и обрабатываем каждый отдельно
    allRatings.forEach((rating,ratingIndex) => {
        ...
        stars.forEach((star, i) => {
            ...
            localStorage.setItem(`rating_${ratingIndex}`, currentStarLevel);// Сохраняем выбранный рейтинг в Local Storage

            }
        });

    // Загружаем сохраненный рейтинг при загрузке страницы
    const savedRating = localStorage.getItem(`rating_${ratingIndex}`);
